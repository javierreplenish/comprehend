  ...
  const authForm = (
    <div style={{ width: "100%", maxWidth: 380, margin: "0 auto", display: "flex", flexDirection: "column", gap: "0.6rem" }}>
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <a href="/api/auth/google" className="btn" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", width: "100%", textDecoration: "none", fontSize: "0.88rem", marginBottom: "0.5rem" }} onClick={(e) => { e.preventDefault(); fetch("/api/auth/google/check").then(r=>r.json()).then(d=>{ if(d.configured) window.location.href="/api/auth/google"; else alert("Google sign-in isn't configured yet. Use email and password for now."); }).catch(()=>window.location.href="/api/auth/google"); }}>
